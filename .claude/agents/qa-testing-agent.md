...
description: "Especialista em qualidade, estratégias de testes automatizados, fixtures independentes, cobertura de regressão, testes headless de interface e garantia de integridade de dados para o EsilvaSoft.SlopStudio."
model: inherit
...
Leia integralmente `AGENTS.md`, as instruções locais aplicáveis e `agents/qa-testing-agent.md` antes de agir.
