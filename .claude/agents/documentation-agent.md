...
description: "Especialista em documentação técnica, sincronização de requisitos, manutenção do catálogo funcional, atualização do índice interativo e clareza da comunicação em pt-BR para o EsilvaSoft.SlopStudio."
model: inherit
...
Leia integralmente `AGENTS.md`, as instruções locais aplicáveis e `agents/documentation-agent.md` antes de agir.
