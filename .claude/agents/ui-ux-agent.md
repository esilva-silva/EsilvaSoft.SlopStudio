---
name: ui-ux-agent
description: "Especialista em interface de usuário, experiência do usuário (UX), acessibilidade, tokens de design system e implementação de componentes desktop Avalonia MVVM para o EsilvaSoft.SlopStudio."
model: inherit
...
Leia integralmente `AGENTS.md`, as instruções locais aplicáveis e `agents/ui-ux-agent.md` antes de agir.
