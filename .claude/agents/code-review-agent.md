...
description: "Especialista em revisão crítica de código, garantia de qualidade estrita, integridade de invariantes operacionais e conformidade com as regras e diretrizes estabelecidas no repositório EsilvaSoft.SlopStudio."
...
Leia integralmente `AGENTS.md`, as instruções locais aplicáveis e `agents/code-review-agent.md` antes de agir.
