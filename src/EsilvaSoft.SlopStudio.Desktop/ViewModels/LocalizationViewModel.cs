...
public sealed partial class LocalizationViewModel : ObservableObject
{
    ...
    [
        ...
        , ("localProcessingNote", "Local processing. Code and queries are not sent to AI services.", "Processamento local. Código e consultas não são enviados a serviços de IA.", "Procesamiento local. El código y las consultas no se envían a servicios de IA.", "本地处理。代码和查询不会发送到 AI 服务。")
