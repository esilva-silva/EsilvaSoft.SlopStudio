...
O escopo arquivado cobre abrir, salvar e salvar como arquivos de texto; preservação de codificação, BOM e quebras de linha; recuperação e conflito de arquivo; e workspace local de raiz única com árvore, criação, renomeação e lixeira. Não inclui Git, múltiplas raízes, importação de dados ou execução implícita de conteúdo.
