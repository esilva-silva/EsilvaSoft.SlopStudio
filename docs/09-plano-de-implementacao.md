...
| 4 | v0.8.0 | Abertura e salvamento de arquivos de texto e workspace local de uma pasta | [Planejada](phases/phase-04-v0.8.0/README.md). Inclui Abrir/Salvar/Salvar como, painel Arquivos com raiz única e operações de arquivo/pasta; faltam implementação integrada e homologação nativa |
