...
**Versão atual identificável:** a meta v0.8.0 fechou os escopos funcionais das fases 1–4 e arquivou suas documentações em [`done/`](done/README.md). A homologação manual permanece na Fase 8; os pacotes locais são gerados pelo fluxo de release e não implicam publicação remota. As tags históricas não foram alteradas.
...
2. Avançar pelas fases 6 e 7 na ordem do roadmap, reutilizando implementações antecipadas e preservando proteções.
