...
| --- | --- | --- | --- |
| 1 | v0.5.0 | MVP: conectar → navegar → consultar → visualizar → editar → exportar | [Escopo funcional implementado](phases/phase-01-v0.5.0/README.md); validação manual transferida para a [Fase 8 / v0.12.0](phases/phase-08-v0.12.0/README.md) |
| 2 | v0.6.0 | Organização dos projetos e autocomplete básico | [**Em execução**](phases/phase-02-v0.6.0/README.md). Núcleos separados e autocomplete determinístico implementados no recorte automatizado |
...
| 4 | v0.8.0 | Abertura e salvamento de arquivos de texto e workspace local de uma pasta | [Planejada](phases/phase-04-v0.8.0/README.md). Inclui Abrir/Salvar/Salvar como, painel Arquivos com raiz única e operações de arquivo/pasta |
...
| 8 | v0.12.0 | Homologação manual e validação em ambientes reais | [Planejada](phases/phase-08-v0.12.0/README.md). Consolida plataformas, acessibilidade, MongoDB/mongosh, hardware, instalação e atualização reais |
| 9 | v1.0.0 | Estabilidade, revisão completa, instalação e atualizações | [Planejada](phases/phase-09-v1.0.0/README.md). Release estável após os aceites funcionais e a Fase 8 |
...
- **Release arquivada** — versão cujo escopo funcional foi fechado e movido para [`done/`](done/README.md). Arquivar **não** significa homologar; a validação manual aplicável pertence à Fase 8.
