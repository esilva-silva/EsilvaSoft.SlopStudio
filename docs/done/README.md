...
| [`release_v0.6.0`](release_v0.6.0/README.md) | Organização dos projetos e autocomplete básico | Escopo funcional fechado; homologação manual transferida para a [Fase 8 / v0.12.0](../phases/phase-08-v0.12.0/README.md). |
| [`release_v0.7.0`](release_v0.7.0/README.md) | Autocomplete com IA explícita | Escopo funcional fechado; homologação manual transferida para a [Fase 8 / v0.12.0](../phases/phase-08-v0.12.0/README.md). |
| [`release_v0.8.0`](release_v0.8.0/README.md) | Arquivos de texto e workspace local de uma pasta | Escopo funcional fechado; homologação nativa transferida para a [Fase 8 / v0.12.0](../phases/phase-08-v0.12.0/README.md). |
