...
**Estado: aceita para a documentação; estrutura substituída em 18/09/2026 pelo roadmap de oito fases.** O plano anterior F0–F7 misturava abrangência futura com recursos já implementados e vinculava scripts/administração ao MVP. O registro inicial de seis fases foi sucedido por: v0.5.0 MVP; v0.6.0 organização/autocomplete determinístico; v0.7.0 autocomplete com IA; v0.8.0 arquivos de texto; v0.9.0 IA local; v0.10.0 administração/manutenção; v0.11.0 chat baseado em workflow; v1.0.0 estabilidade. O [roadmap](09-plano-de-implementacao.md) é a fonte corrente.
